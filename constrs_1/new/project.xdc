...
set_property PACKAGE_PIN V16 [get_ports {ir}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {ir}] 
set_property PACKAGE_PIN W16 [get_ports {il}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {il}] 
set_property PACKAGE_PIN W17 [get_ports {dr}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {dr}] 
set_property PACKAGE_PIN W15 [get_ports {dl}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {dl}] 
...
#Buttons 
set_property PACKAGE_PIN U18 [get_ports chPlayer]  	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports chPlayer] 
set_property PACKAGE_PIN T18 [get_ports rowSel1]  	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports rowSel1] 
set_property PACKAGE_PIN W19 [get_ports rowSel4]  	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports rowSel4] 
set_property PACKAGE_PIN T17 [get_ports rowSel2]  	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports rowSel2] 
set_property PACKAGE_PIN U17 [get_ports rowSel3]  	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports rowSel3]  
